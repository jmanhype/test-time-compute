...
from inference_with_gists import GenerationConfig, Gist, InferenceWithGists, StopReason
...
class TestInferenceWithGists(unittest.TestCase):
    ...
    def test_low_probability_stopping(self):
        ...
        self.assertIsInstance(text, str)
        self.assertTrue(reason in [StopReason.LOW_PROBABILITY, StopReason.MAX_LENGTH])
