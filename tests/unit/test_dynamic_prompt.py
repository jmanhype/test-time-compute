...
class TestDynamicPrompt(unittest.TestCase):
    ...
    def test_example_inclusion(self):
        ...
        prompt_basic = get_dynamic_prompt("coding", "Write a hello world program", difficulty="basic")
        self.assertNotIn("Example Problem", prompt_basic)
        
        # Advanced coding should include example
        prompt_advanced = get_dynamic_prompt("coding", "Implement a red-black tree", difficulty="advanced")
